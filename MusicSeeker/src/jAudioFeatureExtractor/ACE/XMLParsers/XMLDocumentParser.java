...
//		reader.setErrorHandler(new ParsingXMLErrorHandler());
		...
		else throw new Exception(new String("HOLA1 Invalid type of XML file specified. The XML file type " + document_type + " is not known."));
...
//		reader.setContentHandler(handler);
		...
		{
			throw new Exception("HOLA2 The " + file_path + " file is not a valid XML file.\n\nDetails of the problem: " + e.getMessage() +
		...
		{
			throw new Exception("HOLA3 The " + file_path + " file must be of type " + document_type + ". " + e.getMessage());
		}
		catch (Exception e) // throw an exception if the file is not an XML file of the correct type
		{
			throw new Exception("HOLA5 The " + file_path + " file is not formatted properly.\n\nDetails of the problem: " + e.getMessage());
		}
